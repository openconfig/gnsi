# gNSI.console Telemetry Extension

## `gnsi-console.yang`

An overview of the changes defined in the `gnsi-console.yang ` file are shown
below.
...
`gnsi-console.yang` file is shown below.

For interactive version click [here](gnsi-console.html).
